...
// UI_VirtualJoystick
public class UI_VirtualJoystick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    ...
    private void Update()
    {
        if (joyDrag)
        {
            ...
            if (joy_fID != -1)
            {
                ...
                MobileControls.joy_tIdx = joy_tIdx;
            }
    ...
    public void OnPointerUp(PointerEventData ped)
    {
        if (ped.pointerId == joy_fID)
        {
            ...
            joyDrag = false; joy_fID = -1; MobileControls.joy_tIdx = -1;
        }
    }
}
