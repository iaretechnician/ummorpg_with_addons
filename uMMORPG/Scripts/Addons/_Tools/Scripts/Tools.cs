...
public partial class UMMO_Tools
{
    ...
    // Vérifie si le client a cliqué sur un objet cliquable dans la scène (pas sur l'interface utilisateur)
    // @Client
    // -----------------------------------------------------------------------------------
    ...
    // Valide la plage d'interaction, l'état du joueur et si le joueur est vivant ou non
    // @Client OR @Server
    // -----------------------------------------------------------------------------------
