...
// ===================================================================================
[Serializable]
public partial class Tools_Popup : MonoBehaviour
{
    public bool forceUseChat;

    protected Tools_UI_Popup instance;
    ...
    {
        if (instance == null)
            instance = FindFirstObjectByType<Tools_UI_Popup>();
            //instance = FindObjectOfType<Tools_UI_Popup>();
    }
