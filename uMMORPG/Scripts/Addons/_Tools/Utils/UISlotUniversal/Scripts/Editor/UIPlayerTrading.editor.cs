...
{
    private string prefabName = "SlotUniversalPlayerTrading"; // Nom du prefab par défaut, peut être modifié selon ton besoin

    public override void OnInspectorGUI()
    {
        DrawDefaultInspector();

        UIPlayerTrading uiEquipment = (UIPlayerTrading)target;
