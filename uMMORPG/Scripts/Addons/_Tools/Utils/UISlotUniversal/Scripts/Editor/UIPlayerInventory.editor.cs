...
public partial class UIPlayerInventoryEditor : Editor
{
    private string prefabName = "SlotUniversalInventory"; // Nom du prefab par défaut, peut être modifié selon ton besoin

    public override void OnInspectorGUI()
    {
        DrawDefaultInspector();

        UIInventory uiEquipment = (UIInventory)target;
